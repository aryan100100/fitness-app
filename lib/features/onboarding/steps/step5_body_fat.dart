// [HEALTH APP] — Onboarding Step 5: Body Fat Range (was Step 4 in Feature 2)
// Optional. Reordered to after Activity Level per updated spec.
...
class Step5BodyFat extends StatelessWidget {
  final OnboardingController controller;
  final VoidCallback onNext;

  const Step5BodyFat({super.key, required this.controller, required this.onNext});
  ...
  static const _rangeKeys = <String>[
          ...
          children: [
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Optional — select the range closest to you.\nThis fine-tunes your calorie and protein estimates.',
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemCount: _rangeKeys.length,
                separatorBuilder: (ctx, i) =>
                    const SizedBox(height: AppSpacing.cardSpacing),
                itemBuilder: (ctx, i) {
                  final key = _rangeKeys[i];
